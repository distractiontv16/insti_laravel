    ...
    <div class="min-h-screen flex">
        ...
        <div class="bg-gray-800 text-white w-64 space-y-6 py-7 px-2 fixed h-full">
            <nav class="space-y-3">
                ...
                <a href="{{ route('admin.news.index') }}" class="block py-2.5 px-4 rounded hover:bg-gray-700">
                    Actualités
                </a>
                <a href="{{ route('admin.media.index') }}" class="block py-2.5 px-4 rounded hover:bg-gray-700">
                    Médiathèque
                </a>
            </nav>
        </div>
